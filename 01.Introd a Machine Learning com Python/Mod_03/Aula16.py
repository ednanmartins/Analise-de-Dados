# Aula 16 - Tratamento de Atributos Categoricos: OneHot Encoder
...
# Aplica a codificação one-hot nas colunas especificadas e mantém as demais colunas
x_census = onehotencoder_census.fit_transform(x_census).toarray()

x_census  # Resultado após a codificação one-hot
